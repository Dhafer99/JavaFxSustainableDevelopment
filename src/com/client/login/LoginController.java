...
public class LoginController implements Initializable {
    ...
    public void showScene() throws IOException {
        Platform.runLater(() -> {
            ...
            con.setUsernameLabel(projetpidd.ProjetPiDD.user.getNom());
            con.setImageLabel(projetpidd.ProjetPiDD.user.getImage());
        });
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        selectedPicture.setVisible(true);

        /* Drag and Drop */
        borderPane.setOnMousePressed(event -> {
            xOffset = ProjetPiDD.getPrimaryStage().getX() - event.getScreenX();
            yOffset = ProjetPiDD.getPrimaryStage().getY() - event.getScreenY();
            borderPane.setCursor(Cursor.CLOSED_HAND);
        });

        borderPane.setOnMouseDragged(event -> {
            ProjetPiDD.getPrimaryStage().setX(event.getScreenX() + xOffset);
            ProjetPiDD.getPrimaryStage().setY(event.getScreenY() + yOffset);
        ...
        String hostname = hostnameTextfield.getText();
        int port = Integer.parseInt(portTextfield.getText());
        String username = projetpidd.ProjetPiDD.user.getNom();
        String picture = selectedPicture.getText();
        Defaultview.setImage(new Image(projetpidd.ProjetPiDD.user.getImage()));
    ...
    public void minimizeWindow(){
        ProjetPiDD.getPrimaryStage().setIconified(true);
    }
