...
public class ChatController implements Initializable {
    ...
    public void setImageLabel() throws IOException {
        this.userImageView.setImage(new Image(projetpidd.ProjetPiDD.user.getImage()));
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        setUsernameLabel(projetpidd.ProjetPiDD.user.getNom());
    ...
    public void logoutScene() {
        Platform.runLater(() -> {
            ...
            Stage stage = ProjetPiDD.getPrimaryStage();
    ...
    private void Retour(ActionEvent event) throws IOException {
        ...
        m.changeScene("/projetpidd/UserProfileController.fxml");
    }
}