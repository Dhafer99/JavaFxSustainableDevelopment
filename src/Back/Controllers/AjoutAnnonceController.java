...
private CategorieAnnonceListData categeListdata = new CategorieAnnonceListData();
    /**
...
public String filterBadWords(String text) {
    ...
    private void ajouter(MouseEvent event) throws IOException {
        if (ValidateEmptyForm(tf_description, tf_adresse)) {
            ...
            ServiceCategorieAnnonce cdao = new ServiceCategorieAnnonce(); 
        ...
        String formattedDate = formatter.format(date_publication);
           ...
           String imagep = lien;
            ...
            ServiceAnnonce promotiondao = new ServiceAnnonce();
            promotiondao.insert(p);
        //     FXMLLoader loader = new FXMLLoader(getClass().getResource("sample2.fxml"));
        
       // Parent root = loader.load();
     //   AjoutAnnonceController c = loader.getController();
